...
This project is a fork of the [flashbot](https://github.com/wuxudong/flcomputer developed by [wuxudong](https://github.com/wuxudong).

***⚡ Run ADB commands without a computerADB commands by connecting your Android smartphone to your smartphone.
